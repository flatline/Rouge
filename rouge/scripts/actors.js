...
var dirVectors = { "n" : [-1,0], "s" : [1,0], "e" : [0,1], "w" : [0,-1], "ne" : [-1,1], "se" : [1,1], "nw" : [-1,-1], "sw" : [1,-1] };
...
function Character() {
   	...
   	this.attack = function(target, map) {
  		    ...
  		    if (typeof(target) === "undefined" || typeof(target.loc) === "undefined" || target.loc === null || !target.active) {
  		    ...
  		    if (map.distance(this.loc, target.loc) <= 1) {
 			        ...
 			        if (hit > 0) {
    				        ...
    				        map.messages.push(this.name + " hit " + target.name + " for " + dmg + " points of damage");				
